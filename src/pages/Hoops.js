...
export default function Dolls(props) {
  ...
  const getproductsByPagination = async (page_id) => {
    let res = await axios.get(
      `https://api.hopesdolls.com/api/products/some/651ec10bffdc8668b22aed5f?page=${page_id}`,
      {
        headers: {
          "ngrok-skip-browser-warning": "anyvalue",
        },
  ...
  const getCollections = async () => {
    let res = await axios.get(
      `https://api.hopesdolls.com/api/collections/some/651ec10bffdc8668b22aed5f`,
      {
        headers: {
          "ngrok-skip-browser-warning": "anyvalue",
        },
